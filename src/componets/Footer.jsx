      ...
      <footer id='contacto'>
        ...
        <h2>Calculando</h2>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/arielmarchesano/" target="_blank" rel="noopener noreferrer"><img src={linkedin} alt="linkedin icon"/></a>
            <a href="https://github.com/ArielMarno" target="_blank" rel="noopener noreferrer"><img src={github} alt="github icon"/></a>
